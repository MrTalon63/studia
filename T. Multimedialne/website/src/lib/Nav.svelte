...
<header class="bg-gray-300 p-4 text-black">
	<div class="mx-auto flex max-w-7xl items-center justify-between">
		<a href="https://bsd.ktit.polsl.pl/~czop/" aria-label="Strona Główna">
			<div class="flex items-center space-x-2 text-2xl font-bold">
				<svg
					...
					><g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd"
						><g transform="translate(-420.000000, -3641.000000)" fill="#000000"
		...
		<nav class="hidden space-x-8 md:flex">
			<a href="https://bsd.ktit.polsl.pl/~czop/" class="hover:text-gray-400">Strona Główna</a>
			<a href="galeria" class="hover:text-gray-400">Galeria</a>
			<a href="audio" class="hover:text-gray-400">Audio</a>
			<a href="wideo" class="hover:text-gray-400">Wideo</a>
			<a href="rss" class="hover:text-gray-400">Kanały RSS</a>
		</nav>
